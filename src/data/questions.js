...
{n:"2",text:"A 200-g mass on a spring with k=10N/m is subject to external force 4sin10t N and damping = (3/2)×velocity. Find position as a function of time.",ptype:"spring",solution:"$M=0.2$ kg, $k=10$ N/m, $\\beta=1.5$ kg/s, $F=4\\sin 10t$ N.\nDE: $0.2x''+1.5x'+10x=4\\sin 10t \\to 2x''+15x'+100x=40\\sin 10t$.\n$y_h$: $2m^2+15m+100=0 \\to m=\\frac{-15\\pm 5\\sqrt{23}\\,i}{4}$ (underdamped).\n$y_p=A\\sin 10t+B\\cos 10t$: $-100A-150B=40$; $150A-100B=0 \\to A=-\\frac{8}{65}$, $B=-\\frac{12}{65}$.\nApply ICs $x(0)=x'(0)=0$ to find $C_1$, $C_2$.\n>>$x(t) = e^{-15t/4}\\!\\left(C_1\\cos\\tfrac{5\\sqrt{23}\\,t}{4}+C_2\\sin\\tfrac{5\\sqrt{23}\\,t}{4}\\right)-\\tfrac{8\\sin 10t+12\\cos 10t}{65}$<<"},
{n:"3",text:"Series LC circuit: 0.001F capacitor, 2H inductor, 20V DC battery in series. No initial charge. Find I(t).",ptype:"circuit",solution:"DE: $2Q''+1000Q=20 \\to Q''+500Q=10$.\n$m=\\pm\\sqrt{500}\\,i=\\pm 10\\sqrt{5}\\,i$. $Q_h=C_1\\cos(10\\sqrt{5}\\,t)+C_2\\sin(10\\sqrt{5}\\,t)$; $Q_p=\\tfrac{1}{50}$.\nICs: $Q(0)=0 \\to C_1=-\\tfrac{1}{50}$; $Q'(0)=I(0)=0 \\to C_2=0$.\n$Q(t)=\\tfrac{1}{50}(1-\\cos(10\\sqrt{5}\\,t))$.\n>>$I(t) = \\frac{\\sqrt{5}}{5}\\sin(10\\sqrt{5}\\,t)$ A<<"},
{n:"4",text:"Series RLC circuit: 0.02F capacitor, 100Ω resistor, 1H inductor in series. Q(0)=5C. Find Q(t).",ptype:"circuit",solution:"DE: $Q''+100Q'+50Q=0$.\nAuxiliary: $m^2+100m+50=0 \\to m=-50\\pm 35\\sqrt{2}$.\n$m_1\\approx -0.503$, $m_2\\approx -99.497$ (overdamped).\nICs: $C_1+C_2=5$; $m_1 C_1+m_2 C_2=0 \\to C_1=\\frac{5m_2}{m_2-m_1}$, $C_2=\\frac{-5m_1}{m_2-m_1}$.\n>>$Q(t) = C_1 e^{m_1 t}+C_2 e^{m_2 t}$ C<<"},
...
{n:"6",text:"A mass M attached to a spring k is released from rest at t=0. No damping. Find displacement as a function of time.",ptype:"spring",solution:"DE: $Mx''+kx=0$; $\\omega_0=\\sqrt{k/M}$.\nGeneral: $x(t)=C_1\\cos\\omega_0 t+C_2\\sin\\omega_0 t$.\nICs $x(0)=x_0$, $x'(0)=0 \\to C_1=x_0$, $C_2=0$.\n>>$x(t) = x_0\\cos(\\omega_0 t)$<<  (amplitude $x_0$, period $2\\pi/\\omega_0$)"},
{n:"7",text:"(a) A 0.5-kg mass on a table is attached to a spring with k=18N/m; stretched 5cm and released. Friction force = 0.5N. Show the DE is d²x/dt²+36x=1, x(0)=0.05, x'(0)=0. (b) Find where the mass first comes to rest. Will it move again?",ptype:"spring",solution:"(a) Friction $=0.5$ N (opposing motion). DE: $0.5x''+18x=0.5 \\to x''+36x=1$. ICs $x(0)=0.05$, $x'(0)=0$.\n(b) $m=\\pm 6i$. $x(t)=C_1\\cos 6t+C_2\\sin 6t+\\tfrac{1}{36}$.\nICs: $C_1=0.05-\\tfrac{1}{36}=\\tfrac{1}{45}$; $C_2=0$.\n$x(t)=\\tfrac{1}{45}\\cos 6t+\\tfrac{1}{36}$. First rest: $x'=0 \\to \\sin 6t=0 \\to t=\\tfrac{\\pi}{6}$.\n$x\\!\\left(\\tfrac{\\pi}{6}\\right)=-\\tfrac{1}{45}+\\tfrac{1}{36}=\\tfrac{1}{180}$ m.\nSpring force $=18\\cdot\\tfrac{1}{180}=0.1$ N $<$ friction $0.5$ N $\\to$ mass stays at rest."},
{n:"8",text:"Repeat Exercise 7 with the mass pulled 25cm to the right.",ptype:"spring",solution:"Same DE: $x''+36x=1$. ICs $x(0)=0.25$, $x'(0)=0$.\n$x(t)=C_1\\cos 6t+C_2\\sin 6t+\\tfrac{1}{36}$.\nICs: $C_1=0.25-\\tfrac{1}{36}=\\tfrac{2}{9}$; $C_2=0$.\n$x(t)=\\tfrac{2}{9}\\cos 6t+\\tfrac{1}{36}$. First rest at $t=\\tfrac{\\pi}{6}$: $x\\!\\left(\\tfrac{\\pi}{6}\\right)=-\\tfrac{2}{9}+\\tfrac{1}{36}=-\\tfrac{7}{36}$ m.\nSpring force $=18\\cdot\\tfrac{7}{36}=3.5$ N $>$ friction $0.5$ N $\\to$ mass WILL continue to move."},
{n:"9",text:"An uncharged 0.1F capacitor, 0.5H inductor, and 3Ω resistor in series. Current at t=0 is 1A. Find the maximum charge on the capacitor.",ptype:"circuit",solution:"DE: $0.5Q''+3Q'+10Q=0 \\to Q''+6Q'+20Q=0$.\nAuxiliary: $m^2+6m+20=0 \\to m=-3\\pm\\sqrt{11}\\,i$.\n$Q(t)=e^{-3t}(C_1\\cos\\sqrt{11}\\,t+C_2\\sin\\sqrt{11}\\,t)$.\nICs: $Q(0)=0 \\to C_1=0$; $I(0)=Q'(0)=1 \\to C_2\\sqrt{11}=1 \\to C_2=\\tfrac{1}{\\sqrt{11}}$.\n$Q(t)=\\tfrac{e^{-3t}}{\\sqrt{11}}\\sin(\\sqrt{11}\\,t)$.\nMaximum when $Q'=0 \\to \\tan(\\sqrt{11}\\,t)=\\tfrac{\\sqrt{11}}{3} \\to t^*=\\tfrac{1}{\\sqrt{11}}\\arctan\\tfrac{\\sqrt{11}}{3}$.\n>>$Q_{\\max} \\approx 0.105$ C<<"},
...
{n:"12",text:"A 100-g mass on a spring with k=4000N/m: x(0)=0, x'(0)=10m/s, external force 3cos200t. Find x(t). Does resonance occur?",ptype:"spring",solution:"$\\omega_0=\\sqrt{k/M}=\\sqrt{4000/0.1}=200$ rad/s $=$ forcing frequency $\\to$ RESONANCE.\nDE: $x''+40000x=30\\cos 200t$; $\\cos 200t$ in $y_h$ $\\to$ $y_p=t(A\\cos 200t+B\\sin 200t)$.\n$y_p''+40000y_p=400B\\cos 200t-400A\\sin 200t=30\\cos 200t \\to B=\\tfrac{3}{40}$, $A=0$.\nICs: $C_1=0$; $200C_2=10 \\to C_2=\\tfrac{1}{20}$.\n>>$x(t) = \\tfrac{1}{20}\\sin 200t+\\tfrac{3t}{40}\\sin 200t$ m<<  (grows without bound — resonance)"},
{n:"13",text:"A 1-kg mass on a spring with k=64N/m: F(t)=2sin8t, x(0)=x'(0)=0, no damping. Find x(t). What happens as t→∞?",ptype:"spring",solution:"$\\omega_0=\\sqrt{64}=8=$ forcing frequency $\\to$ RESONANCE.\nDE: $x''+64x=2\\sin 8t$; $\\sin 8t$ in $y_h$ $\\to$ $y_p=t(A\\cos 8t+B\\sin 8t)$.\n$y_p''+64y_p=16B\\cos 8t-16A\\sin 8t=2\\sin 8t \\to A=-\\tfrac{1}{8}$, $B=0$.\nICs: $C_1=0$; $8C_2-\\tfrac{1}{8}=0 \\to C_2=\\tfrac{1}{64}$.\n>>$x(t) = \\frac{1}{64}\\sin 8t-\\frac{t}{8}\\cos 8t$ m<<  (grows without bound as $t\\to\\infty$)"},
{n:"14",text:"A mass M on a spring k is subjected to force Acosωt. Find the forcing frequency ω that causes resonance.",ptype:"spring",solution:"DE: $Mx''+kx=A\\cos\\omega t$. $\\omega_0=\\sqrt{k/M}$.\nResonance when forcing frequency equals natural frequency.\nAt $\\omega=\\omega_0$: $y_p=\\frac{A}{2M\\omega_0}\\,t\\sin(\\omega_0 t)$ — grows without bound.\n>>$\\omega = \\omega_0 = \\sqrt{k/M}$<<"},
...
{n:"19",text:"A spring-mounted two-wheel trailer of mass 400 kg is towed at speed v over an undulating road $Y=Acos(πx/5)$ m. No damping, spring constant 40000 N/m. Find the speed at which resonance occurs.",ptype:"spring",solution:"$\\omega_0=\\sqrt{k/M}=\\sqrt{40000/400}=10$ rad/s.\nRoad profile: $Y=A\\cos(\\pi x/5)$ m. At speed $v$, $x=vt$, so forcing frequency $\\omega=\\pi v/5$.\nResonance: $\\omega=\\omega_0 \\to \\frac{\\pi v}{5}=10$.\n>>$v = \\frac{50}{\\pi}\\approx 15.9$ m/s<<"},
