...
{n:"1",text:"A 1-kg mass on a spring with k=16N/m is pulled 10cm below equilibrium and released. Find x(t) for: (a) no damping, (b) damping force = 0.1×velocity N, (c) damping force = 10×velocity N. Classify the motion in each case.",ptype:"spring",solution:"(a) $β=0$: $x''+16x=0→m=±4i$. ICs $x(0)=−0.1$, $x'(0)=0$.\n>>$x(t) = −0.1cos4t$<<  (simple harmonic, amplitude $0.1$ m, period $π/2$ s)\n(b) $β=0.1$: $m²+0.1m+16=0→m≈−0.05±√15.9994i$ — underdamped.\n$x(t)=e^{−0.05t}(C₁cos√15.9994·t+C₂sin√15.9994·t)$. Apply ICs.\n(c) $β=10$: $(m+2)(m+8)=0→m=−2,−8$ — overdamped.\n$C₁+C₂=−0.1$, $−2C₁−8C₂=0→C₁=−4C₂→C₂=1/30$, $C₁=−2/15$.\n>>$x(t) = −(2/15)e⁻²ᵗ+(1/30)e⁻⁸ᵗ$<<"},
...
{n:"15",text:"A 25/9 H inductor, 0.04F capacitor, and generator 15cos3t in series. Find I(t). Does resonance occur?",ptype:"circuit",solution:"$ω₀=1/√(LC)=1/√(25/(9·0.04))=1/√(25/0.36)=0.6/5=3/5·... = 3$ rad/s.\nForcing $ω=3=ω₀$ → RESONANCE.\nDE (in terms of $I$): $(25/9)I''+25I=−45sin3t→5I''+45I=−81sin3t→I''+9I=−81sin3t/5$.\n$±3i$ are roots → $Iₚ=(27t/10)cos3t$.\nICs $I(0)=0$, $I'(0)=0→C₁=0$; $3C₂+27/10=0→C₂=−9/10$.\n>>$I(t) = −(9/10)sin3t+(27t/10)cos3t$ A<<  (resonance confirmed)"},
